...
export const draftTableMap: Record<DraftType, { table: string; permission: string; targetTable: string }> = {
  ...
  moq: { table: "catalogue_moq_drafts", permission: "catalogue.moq.submit", targetTable: "product_moq_rules" },
  pricing: { table: "catalogue_pricing_drafts", permission: "catalogue.pricing.submit", targetTable: "product_pricing_rules" },
