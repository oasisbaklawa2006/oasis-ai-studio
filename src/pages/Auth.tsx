      ...
      <div className="hidden lg:flex gradient-hero text-primary-foreground p-12 flex-col justify-between relative overflow-hidden">
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            <div className="h-11 w-11 rounded-lg gradient-gold flex items-center justify-center font-display text-2xl text-primary">
              O
            </div>
            <div>
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="opacity-80">
            One studio for product mastery, media, hampers, labels, and AI-assisted catalogue
            creation — built for Oasis teams.
          </p>
        </div>
      ...
      <div className="flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-muted-foreground mb-8 text-sm">
            Sign in to your Oasis Studio account.
          </p>
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignUp} className="space-y-4 mt-6">
                ...
                <p className="text-xs text-muted-foreground">
                  First registered user becomes the Owner. Subsequent users are assigned the Sales
                  role and can be promoted.
                </p>
              </form>
            </TabsContent>
          </Tabs>
          ...
          <div className="space-y-2">
            ...
            >
              <svg aria-hidden="true" className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                <path d="M16.365 1.43c0 1.14-.42 2.23-1.18 3.04-.81.86-2.13 1.52-3.21 1.43-.13-1.13.42-2.31 1.16-3.06.83-.85 2.24-1.49 3.23-1.41zM20.5 17.36c-.55 1.27-.81 1.84-1.52 2.96-.99 1.56-2.39 3.5-4.13 3.52-1.54.02-1.94-1-4.04-.99-2.1.01-2.54 1.01-4.08.99-1.74-.02-3.06-1.78-4.05-3.34C-.05 16.16-.34 11.07 1.4 8.32c1.24-1.96 3.2-3.11 5.04-3.11 1.88 0 3.06 1.03 4.61 1.03 1.5 0 2.42-1.03 4.59-1.03 1.65 0 3.4.9 4.64 2.46-4.08 2.24-3.42 8.07.22 9.69z" />
              </svg>
              Continue with Apple
            </Button>
          </div>
