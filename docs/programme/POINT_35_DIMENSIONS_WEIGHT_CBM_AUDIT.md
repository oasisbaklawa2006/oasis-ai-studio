...
**Issue:** #146 · **PR:** #147  
**Baseline:** `main` @ `33f61f2` (includes #140 + #149)  
...
| `product_dimensions_cm` | Core `products` | Derived on save | `resolveProductDimensionsCmText()` | DB + readiness | None | **None** | Derived from L×W×H when complete |
...
| Gate | Status |
| --- | --- |
| Rebased on current `main` @ `33f61f2` | **PASS** |
