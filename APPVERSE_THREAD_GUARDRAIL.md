...
If an upstream dependency is missing or ambiguous, report `BLOCKED`, route to Mission Control, and stop; never fabricate runtime authority or create a parallel schema. `PR MERGED != STAGE CLEARED`; only Mission Control gates establish programme clearance.
